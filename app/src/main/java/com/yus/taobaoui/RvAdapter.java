...
public class RvAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == HEADER0) {
            ...
            return new HeadlinesHolder(headView5);
        }else if(viewType==HEADER3){
            return new SnapUpHolder(headView3);
        }else if(viewType==HEADER4){
            return new HotGoodsHolder(headView4);
        }else if(viewType==HEADER5){
            return new HotGoodsShowHolder(headView2);
        }
        else {
...
//            Log.d("alan","位置-->"+position);
    ...
    public void addHotGoodsShowView2(View v){
        this.headView2=v;
    }
    /**添加抢购的Header*/
    ...
    /*热销商品*/
    public void addHotGoodsView4(View v){
        this.headView4=v;
    }
    ...
    /*热销商品展示*/
    class HotGoodsShowHolder extends RecyclerView.ViewHolder{

        public HotGoodsShowHolder(View itemView){
            super(itemView);
        }
    }
    /**抢购的Header(4个）*/
